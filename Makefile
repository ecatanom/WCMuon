...
#make all will do the three things: clean, links, etc.
#make clean when you do some modifications, erases remainings in the memory (links between libraries); make all is safer
#first use source setupxx.sh, otherwise it crashes
