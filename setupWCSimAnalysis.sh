...
export LBNE_CODE=/lbne/app/users/ecatanom/muon2014/
...
export LD_LIBRARY_PATH=/lbne/app/users/omanghel/WCSim/branches/dev/DetectorDevelopment:/lbne/app/users/ecatanom/muon2014/lib:$LD_LIBRARY_PATH
...
export PATH=/lbne/app/users/ecatanom/muon2014/bin:$PATH
