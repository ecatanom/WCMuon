...
#Last modification!!! read from condor scratch, not DataFilesDir
 ...
 echo "root -b -q -l '/lbne/app/users/ecatanom/WCSimAnalysis/macros/Ioana_wc_eventntuple_MultiJobs.C(\"${_CONDOR_SCRATCH_DIR}/input/$filename\",\"Reco\",\"$outFile\","$ii")'" >> $jobcmd
