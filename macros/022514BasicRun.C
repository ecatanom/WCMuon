...

{
  ...
  // =======================
  TString filename("/lbne/data2/users/txin/Samples/muplus_1200mev_500kton_10inch_13per_hqe_MuSct.root");  
//TString filename("/lbne/data/water/sim200kton_20111017/singleparticle/wcsimlc/muon_plus_001200MeV_200kton.0001_13percentbare_DetDev_MuSct_Ion.root");
  ...
  WCSimDataCleaner::Instance()->SetNeighbourRadius(400.0); 
  ...
  WCSimDataCleaner::Instance()->SetTimeWindowNeighbours(20.0);
