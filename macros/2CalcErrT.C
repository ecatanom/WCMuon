...
//  string namefile = "muplus_1200mev_200kton_13per_0p1_noMulSct";
//  string namefile = "muplus_1200mev_200kton_13per_mcp1p5_noMulSct";
//  string namefile = "/lbne/data/users/omanghel/200kton_01ns_1nm/addedFiles_200kton_01ns_1nm.root";
  //string namefile = "/lbne/data/users/omanghel/200kton_025ns_2p5nm/addedFiles_200kton_025ns_2p5nm.root";
  //string namefile="/lbne/data/users/omanghel/200kton_13percCov/200kton_01ns_1nm/addedFiles_200kton_01ns_1nm.root";
string namefile = "/lbne/data/users/ecatanom/muonONntuples/muON500kton01ns011414.root";
...
//  RecoChain->Add(("/lbne/app/users/txin/FitResult_root/"+namefile+".root").c_str());
  RecoChain->Add((namefile).c_str());
  //RecoChain->Add(("/lbne/app/users/txin/WCSimAnalysis_bkp20121019/plotroot/"+namefile+".root").c_str());
  ofstream outfile(("/lbne/app/users/ecatanom"+namefile+"_list.txt").c_str());
  ...
  Double_t radius = 4200.0; //3168.94 for 1200MeV, 3112.95 for 400MeV
  Double_t height = 5200.0; //3833.94 for 1200MeV, 3999.04 for 400MeV
  Int_t aaa = 0;
  Int_t bbb = 0;
  Int_t ccc = 0;
...
*/
      ...
      // vertex finder
      // =============
      if((dr2 < radius-300.0) && (pointVtxZ < height-300.0)){
         fiducial_in++;
...
//          testconh->Fill(ds5*sinth5);
          ...
          //testh->Fill(0.01*ds5);
          //testh->Fill(theta6);
          if(ds5*sinth5 < 1.0) cout << eventNum << " ";
//          outfile << eventNum << " " << extendedVtxX << " " << extendedVtxY << " " << extendedVtxZ << " " << extendedDirX << " " << extendedDirY << " " << extendedDirZ << " " << (ds5*costh5) << " " << theta6 << endl;
        }
        else testnonh-> Fill(ds0);
