/*Este programa imprime event displays para una lista de eventos despues de aplicar filtros extra. NO funciona*/

{
  ...
  Double_t hitTmax=(121.02+2*43.66);
  Double_t hitTmin=(121.02-43.66);
  ...
  WCSimDataCleaner::Instance()->SetMinHitTime(-1.0);//this is new
  WCSimDataCleaner::Instance()->SetMaxHitTime(hitTmax);//this is new
