...

{
 ...
 TString filename("/lbne/data/users/ecatanom/samples/muplus_1200mev_500kton_10inch_13per_hqe.root");
  ...
  WCSimDataCleaner::Instance()->SetNeighbourRadius(394.0); 
  WCSimDataCleaner::Instance()->SetNeighbourDigits(54.0);//a 50 b 70
  WCSimDataCleaner::Instance()->SetClusterRadius(394.0);
  WCSimDataCleaner::Instance()->SetClusterDigits(54.0);
  WCSimDataCleaner::Instance()->SetTimeWindowNeighbours(45.0);
  WCSimDataCleaner::Instance()->SetTimeWindowClusters(45.0);
  ...
  for(int ecounter=0;ecounter<7;ecounter++){
