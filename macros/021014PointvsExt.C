...
//string namefile="021314_500kton_20per_05ns";
  ...
  //string namefile="old/muON500kton1ns011414";
  //  string namefile="031714_500kton_13per_1ns_rerun2";
  //   string namefile = "031914eminustemp";
...
radius=1908.34;height=6812.09/2; //50kton
  ...
  Double_t min = 0.0;
  Double_t max = 1000.0;   //100 for parallell?
