...
class WCSimVertexGeometry : public TObject {
 ...
 public:
  ...
  void SetSameEventOverride(Bool_t override); //erika
  ...
  void CalcTResid(Double_t vx, Double_t vy, Double_t vz, Double_t vtxTime,
		      Double_t px, Double_t py, Double_t pz, Double_t hx, Double_t hy, Double_t hz, Double_t ht, Double_t &fTResid, Double_t &Lphoton, Double_t &Ltrack, Double_t &phideg);
  void CalcTResid(Double_t vx, Double_t vy, Double_t vz, Double_t vtxTime,
 ...
 private:
  ...
  Bool_t* fIsFiltered; 
  Bool_t fSameEventOverride; //Erika
