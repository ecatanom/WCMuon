...
void WCSimVertexGeometry::CalcTResid(Double_t vtxX, Double_t vtxY, Double_t vtxZ, Double_t vtxTime, Double_t dirX, Double_t dirY, Double_t dirZ, Double_t hitX, Double_t hitY, Double_t hitZ, Double_t hitT, Double_t &fTResid, Double_t &Lphoton, Double_t &Ltrack, Double_t &phideg)
{
  // reset arrays
  // ============
...
//erika
void WCSimVertexGeometry::SetSameEventOverride(Bool_t override){
  fSameEventOverride=override;
}
